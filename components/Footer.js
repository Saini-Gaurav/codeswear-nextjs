      ...
      <div className="row gy-4 gy-lg-0">
        <div className="col-12 col-md-6 col-lg-4">
          <div className="widget">
            <Link href={"/"}>
            <Image src="/logo.png" alt="Codeswear Logo" height={40} width={200}/>
            </Link>
            <address className="mb-4 px-2">8014 Edith Blvd NE, Albuquerque, New York, United States</address>
            <p className="mb-1">
              <a className="link-secondary text-decoration-none px-2" href="tel:+15057922430">(505) 792-2430</a>
            </p>
            <p className="mb-0">
              <a className="link-secondary text-decoration-none px-2" href="mailto:demo@yourdomain.com">demo@yourdomain.com</a>
            </p>
          </div>
        </div>
